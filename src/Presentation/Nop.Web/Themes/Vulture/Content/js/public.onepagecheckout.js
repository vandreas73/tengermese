...
var Checkout = {
    ...
    gotoSection: function (section) {
        ...
        if (sec == "billing") {
            var topOffset = $(".master-wrapper-content").offset().top;
            var shipToSameAddressTopOffset = $("#opc-billing").offset().top;
            $('html, body').animate({
                scrollTop: shipToSameAddressTopOffset - topOffset + 50
            }, 1000)
        }
        else if (sec == "shipping") {
            var topOffset = $(".master-wrapper-content").offset().top;
            var shipToSameAddressTopOffset = $("#opc-shipping").offset().top;
            $('html, body').animate({
                scrollTop: shipToSameAddressTopOffset - topOffset + 50
            }, 1000)
        }
        else if (sec == "shipping_method") {
            var topOffset = $(".master-wrapper-content").offset().top;
            var shipToSameAddressTopOffset = $("#opc-shipping_method").offset().top;
            $('html, body').animate({
                scrollTop: shipToSameAddressTopOffset - topOffset + 50
            }, 1000)
        }
        else if (sec == "payment_method") {
            var topOffset = $(".master-wrapper-content").offset().top;
            var shipToSameAddressTopOffset = $("#opc-payment_method").offset().top;
            $('html, body').animate({
                scrollTop: shipToSameAddressTopOffset - topOffset + 50
            }, 1000)
        }
            ...
            var topOffset = $(".master-wrapper-content").offset().top;
            var shipToSameAddressTopOffset = $("#opc-payment_info").offset().top;
            $('html, body').animate({
                scrollTop: shipToSameAddressTopOffset - topOffset + 50
            }, 1000)
        }
        else if (sec == "confirm_order") {
            var topOffset = $(".master-wrapper-content").offset().top;
            var shipToSameAddressTopOffset = $("#opc-confirm_order").offset().top;
            $('html, body').animate({
                scrollTop: shipToSameAddressTopOffset - topOffset + 50
            }, 1000)
        }
