...
# build plugins
WORKDIR /src/Plugins/Nop.Plugin.Misc.RoxyFileManAzure
RUN dotnet build Nop.Plugin.Misc.RoxyFileManAzure.csproj -c Release
...
WORKDIR /src/Plugins/Nop.Plugin.Misc.BillingoInvoicing
RUN dotnet build Nop.Plugin.Misc.BillingoInvoicing.csproj -c Release
